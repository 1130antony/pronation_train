...
public class Quateraion
{
    #region parameters for 6 DoF sensor fusion calculations
    ...
    //六軸四元數法
    public void MadgwickQuaternionUpdate(ref float[] q, float ax, float ay, float az, float gx, float gy, float gz)
    {
    ...
    // measured ones. 
    public float[] eInt = { 0.0f, 0.0f, 0.0f };
    public void MahonyQuaternionUpdate(ref float[] q, float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
    {
        float q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];   // short name local variable for readability
        float norm;
        float hx, hy, bx, bz;
    ...
    //九軸四元數運算
    public void MadgwickQuaternionUpdate(ref float[] q, float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
    {
        float q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];   // short name local variable for readability
        float norm;
